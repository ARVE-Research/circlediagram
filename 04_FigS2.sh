...
# ------------------------------
# 2. Goats Present in OKV

infile=$datadir/Scenario_Goats_Present_in_OKV.csv
...
echo "Goats Present in OKV" | gmt pstext -R -J -F+cTC+f9p,Helvetica-Bold -Dj0.3 -O -P -K >> $output
echo $pop   | gmt pstext -R -J -F+cTR+f9p,Helvetica-Bold -Dj0.3 -O -P -K >> $output

# ------------------------------
# 3. Carabao Herd Absent from OKV

infile=$datadir/Scenario_Carabao_Herd_Absent_from_OKV.csv
...
echo "Carabao Herd Absent from OKV" | gmt pstext -R -J -F+cTC+f9p,Helvetica-Bold -Dj0.3 -O -P -K >> $output
echo $pop   | gmt pstext -R -J -F+cTR+f9p,Helvetica-Bold -Dj0.3 -O -P -K >> $output
